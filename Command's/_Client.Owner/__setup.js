...
if(args[0] === "public" || args[0] === "publickategori") {
    ...
    message.react(`${client.emojis.cache.find(x => x.name === "wex_onay")}`)} 
    ...
    if(args[0] === "banlog" || args[0] === "banbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Ban Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "cpuanlog" || args[0] === "cezapuanlog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Cezapuan Log\` kanalı ${channel} olarak ayarlandı!`)}    
    if(args[0] === "vmutelog" || args[0] === "vmutebilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Voice-Mute Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "meeting" || args[0] === "toplantı") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Toplantı\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "cmutelog" || args[0] === "cmutebilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Chat-Mute Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "jaillog" || args[0] === "jailbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Jail Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "guardlog" || args[0] === "guardbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Guard Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "rolalma" || args[0] === "rol-alma") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Rol-Alma\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "basvurulog" || args[0] === "başvurulog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Başvuru-Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "başvurukanal" || args[0] === "başvuruchannel") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Başvuru-Kanal\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "BotSes" || args[0] === "botses") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Bot Ses\` kanalı ${channel} olarak ayarlandı!`)}
    ...
    if(args[0] === "taglog" || args[0] === "tag-log") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Tag-Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "yttaglog" || args[0] === "yttag-log") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Yetki-Tag-Log\` kanalı ${channel} olarak ayarlandı!`)}
    ...
    if(args[0] === "rolsecim" || args[0] === "rolseçim") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Rol-Seçim\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "kpanel" || args[0] === "kullanıcıpanel") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Kullanıcı-Panel\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "kurallar" || args[0] === "rules") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Kurallar\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "komutkanalar" || args[0] === "commandchannel" || args[0] === "komutkanal") { let Roles;
       ...
       message.react(`${client.emojis.cache.find(x => x.name === "wex_onay")}`)}   
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Genel-Chat\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "register-chat" || args[0] === "registerchat") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`Register-Chat\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "invite-log" || args[0] === "invitelog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "wex_onay")} \`İnvite-Log\` kanalı ${channel} olarak ayarlandı!`)}
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
